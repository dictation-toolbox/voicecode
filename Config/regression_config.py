...
# for Natspeak 6 or later, use this line

capitalize_rules(0)
# for regression testing consistency, always use capitalize_rules(0)
...
C_Cpp_std_sym = os.path.join(vc_globals.test_data, 'test_C_Cpp_std_sym.cpp')
